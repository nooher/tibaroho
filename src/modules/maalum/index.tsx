...
const POPULATIONS: Population[] = [
  { slug: 'mimi-na-hiv', label: 'Mimi & HIV', titleSw: 'MIMI NA HIV', titleEn: 'Living with HIV',
    overview: 'Maisha na HIV yana mizigo ya kihisia — unyanyapaa, kufichuka, kufuata ART, na kupanga maisha mengine. TBHOS ina nafasi salama ya kuongea, kupanga, na kupata mtu wa kuaminika bila hofu ya kuhukumiwa.',
  ...
  { slug: 'mimi-na-kansa', label: 'Mimi & Kansa', titleSw: 'MIMI NA KANSA', titleEn: 'Living with cancer',
    overview: 'Utambuzi wa kansa hubadilisha kila kitu — mwili, mahusiano, matumaini. TBHOS inafanya kazi pamoja na ORCI (Ocean Road Cancer Institute) kuendeleza usaidizi wa kihisia wakati wa matibabu na baada ya matibabu.',
  ...
  { slug: 'mimi-na-mimba', label: 'Mimba', titleSw: 'MIMI NA MIMBA', titleEn: 'Perinatal mental health',
    overview: 'Kabla ya kujifungua na baada yake ni kipindi cha mabadiliko makubwa. TBHOS hutoa tathmini ya EPDS kila trimester, IPT iliyofanyiwa kazi kwa Tanzania, na rufaa ya haraka kwenda kliniki za RCH zinazoshirikiana.',
    ...
    expansions: [
      {
        ...
        body:
          'Karibu 8–12% ya baba/wazazi-wenza hupata unyogovu wa kabla/baada ya kuzaa. Mara nyingi hujificha nyuma ya "lazima niwe imara." TBHOS ina moduli maalum: tathmini ya EPDS-P (paternal), vipindi vya IPT kwa wanandoa, na mazungumzo ya jinsi mabadiliko ya familia yamekuwa kwako wewe pia.',
      },
    ],
  },
  { slug: 'mimi-na-mtoto', label: 'Mtoto', titleSw: 'MIMI NA MTOTO', titleEn: 'Child mental health (4-17)',
    overview: 'Watoto wanaonyesha dhiki tofauti na watu wazima — kupitia tabia, mwili, na shule. TBHOS hutumia SDQ na huleta familia ndani ya tiba.',
  ...
  { slug: 'wazazi', label: 'Wazazi', titleSw: 'WAZAZI', titleEn: 'Parents & caregivers',
    overview: 'Kazi ya uzazi ni nzito — hasa pasipo na msaada. TBHOS ina mipango ya kuongeza ustadi wa malezi, kupunguza msongo, na kujenga jumuiya ya wazazi.',
  ...
  { slug: 'wazee', label: 'Wazee', titleSw: 'WAZEE', titleEn: 'Older adults',
    overview: 'Wazee mara nyingi husahaulika katika huduma za afya ya akili. TBHOS ina mfumo wa heshima — sauti polepole, herufi kubwa, na ushirikiano na vyama vya wazee na mtoto/mjukuu kama mlezi wa pamoja.',
  ...
  { slug: 'wanafunzi', label: 'Wanafunzi', titleSw: 'WANAFUNZI', titleEn: 'Students',
    overview: 'Shule na chuo ni mahali pa shinikizo kubwa: mitihani, mahusiano, ndoa za utotoni, matumizi ya madawa. TBHOS ShulePlus inafanya kazi na shule zenyewe; wanafunzi binafsi pia wanapata sehemu hii.',
    assessments: ['PHQ-A', 'GAD-7', 'CRAFFT', 'SDQ'],
    programs: ['t-CBT — wasiwasi wa mitihani', 'PST — kutatua matatizo', 'MI — substance'],
    providers: 'School counsellors waliosajiliwa TBHOS ShulePlus.',
  ...
  { slug: 'uponyaji', label: 'Uponyaji', titleSw: 'UPONYAJI', titleEn: 'Addiction recovery',
    overview: 'Uponyaji ni safari, sio tukio. TBHOS inashirikiana na NGO za Tanzania za uponyaji (TASUWA, Sober Houses) na hutoa MI + relapse prevention + jumuiya ya rika.',
  ...
  { slug: 'wakimbizi', label: 'Wakimbizi', titleSw: 'WAKIMBIZI', titleEn: 'Refugees / displaced',
    overview: 'Wakimbizi katika Nyarugusu na Nduta wamebeba majeraha ya kiakili kutoka nchi za asili. TBHOS hufanya kazi na UNHCR + IRC kuendeleza CETA iliyotafsiriwa katika lugha za asili (Kirundi, Kongo) na Kiswahili.',
  ...
  { slug: 'magereza', label: 'Magereza', titleSw: 'MAGEREZA', titleEn: 'Incarcerated / post-release',
    overview: 'Mfumo wa magereza Tanzania hauna huduma za kawaida za afya ya akili. TBHOS hutoa moduli rasmi kwa Magereza Tanzania (training ya wapelelezi) na inawasaidia waliotoka tu kuwa na mpango wa kuingia tena kwenye jamii.',
