...
export default function Step3Hali({ profile, update, next, back }: Props) {
  ...
  return (
    <div style={cardStyle}>
      <h2 style={titleStyle}>Hali za kiafya</h2>
      <p style={subStyle}>Kuchagua hapa kunatusaidia kupata vifuatiliaji na ushauri sahihi.</p>
      ...
      <div style={{ marginTop: 16 }}>
        ...
        {pregnant && (
          <div style={{ marginTop: 10, display: 'flex', gap: 8 }}>
            {[1, 2, 3].map((t) => (
              <button key={t} type="button" onClick={() => setTrimester(t as 1 | 2 | 3)} style={chipStyle(trimester === t)}>
                Trimester {t}
              </button>
            ))}
          </div>
