...
-- uuid-ossp removed (use gen_random_uuid from pgcrypto)
...
select
  encode(extensions.digest(o.patient_id::text || coalesce(current_setting('app.salt', true), ''), 'sha256'), 'hex') as patient_hash,
  o.instrument,
  o.score,
  o.delta,
